...
namespace BrightIdeasSoftware
{
  ...
  public class ObjectListView : System.Windows.Forms.ListView, ISupportInitialize
  {
    ...
    private static SmoothingMode smoothingMode = SmoothingMode.HighQuality;
    ...
    public static Bitmap SortAscendingImage = new Bitmap(128, 128);
    public static Bitmap SortDescendingImage = new Bitmap(128, 128);
    ...
    public static bool IsVistaOrLater
    {
      get
      {
        if (!ObjectListView.isVistaOrLater.HasValue)
          ObjectListView.isVistaOrLater = new bool?(Environment.OSVersion.Version.Major >= 6);
    ...
    public static bool IsWin7OrLater
    {
      get
      {
        if (!ObjectListView.isWin7OrLater.HasValue)
        {
          ...
          ObjectListView.isWin7OrLater = new bool?(version.Major > 6 || version.Major == 6 && version.Minor > 0);
        }
    ...
    {
      get => ObjectListView.showCellPaddingBounds;
      set => ObjectListView.showCellPaddingBounds = value;
    }
    ...
    public virtual Color AlternateRowBackColorOrDefault
    {
      get
      {
        return !(this.alternateRowBackColor == Color.Empty) ? this.alternateRowBackColor : Color.LemonChiffon;
      }
    }
    ...
    public virtual object CheckedObject
    {
      get
      {
        ...
        return checkedObjects.Count != 1 ? (object) null : checkedObjects[0];
      }
      set
      {
    ...
    public virtual IList CheckedObjects
    {
      get
      {
        ArrayList checkedObjects = new ArrayList();
        if (this.CheckBoxes)
        {
          for (int index = 0; index < this.GetItemCount(); ++index)
          {
            ...
            if (olvListItem.CheckState == CheckState.Checked)
              checkedObjects.Add(olvListItem.RowObject);
          }
        }
        return (IList) checkedObjects;
      }
      set
      {
        if (!this.CheckBoxes)
    ...
    public virtual List<OLVColumn> ColumnsInDisplayOrder
    {
      get
      {
        OLVColumn[] collection = new OLVColumn[this.Columns.Count];
        foreach (OLVColumn column in this.Columns)
          collection[column.DisplayIndex] = column;
        return new List<OLVColumn>((IEnumerable<OLVColumn>) collection);
      }
    }
    ...
    public virtual string EmptyListMsg
    {
      get
      {
        return this.EmptyListMsgOverlay is TextOverlay emptyListMsgOverlay ? emptyListMsgOverlay.Text : (string) null;
      }
      set
      {
    ...
    public virtual Font EmptyListMsgFont
    {
      get
      {
        return this.EmptyListMsgOverlay is TextOverlay emptyListMsgOverlay ? emptyListMsgOverlay.Font : (Font) null;
      }
      set
      {
        if (!(this.EmptyListMsgOverlay is TextOverlay emptyListMsgOverlay))
    ...
    {
      get => this.EmptyListMsgFont ?? new Font("Tahoma", 14f);
    }
    ...
    public virtual IEnumerable FilteredObjects
    {
      get
      {
        return this.IsFiltering ? this.FilterObjects(this.Objects, this.ModelFilter, this.ListFilter) : this.Objects;
      }
    }
    ...
    public virtual string GroupWithItemCountFormatOrDefault
    {
      get
      {
        return !string.IsNullOrEmpty(this.GroupWithItemCountFormat) ? this.GroupWithItemCountFormat : "{0} [{1} items]";
      }
    }
    ...
    public virtual string GroupWithItemCountSingularFormatOrDefault
    {
      get
      {
        return !string.IsNullOrEmpty(this.GroupWithItemCountSingularFormat) ? this.GroupWithItemCountSingularFormat : "{0} [{1} item]";
      }
    }
    ...
    {
      get => this.headerControl ?? (this.headerControl = new HeaderControl(this));
    }
    ...
    public virtual Color HighlightBackgroundColorOrDefault
    {
      get
      {
        return !this.HighlightBackgroundColor.IsEmpty ? this.HighlightBackgroundColor : SystemColors.Highlight;
      }
    }
    ...
    public virtual Color HighlightForegroundColorOrDefault
    {
      get
      {
        return !this.HighlightForegroundColor.IsEmpty ? this.HighlightForegroundColor : SystemColors.HighlightText;
      }
    }
    ...
    {
      get => this.SelectColumnsOnRightClickBehaviour != ObjectListView.ColumnSelectBehaviour.None;
      set
      {
        if (value)
        {
    ...
    {
      get => this.SelectedIndices.Count != 1 ? -1 : this.SelectedIndices[0];
      set
      {
    ...
    public virtual OLVListItem SelectedItem
    {
      get
      {
        return this.SelectedIndices.Count != 1 ? (OLVListItem) null : this.GetItem(this.SelectedIndices[0]);
      }
      set
      {
        this.SelectedIndices.Clear();
    ...
    public virtual object SelectedObject
    {
      get
      {
        return this.SelectedIndices.Count != 1 ? (object) null : this.GetModelObject(this.SelectedIndices[0]);
      }
      set
      {
    ...
    public virtual IList SelectedObjects
    {
      get
      {
        ...
        foreach (int selectedIndex in this.SelectedIndices)
          selectedObjects.Add(this.GetModelObject(selectedIndex));
        return (IList) selectedObjects;
      }
      set
      {
        this.SelectedIndices.Clear();
    ...
    {
      get => this.BaseSmallImageList != null ? this.BaseSmallImageList.ImageSize : new Size(16, 16);
    }
    ...
    public virtual int TopItemIndex
    {
      get
      {
        return this.View == View.Details && this.IsHandleCreated ? NativeMethods.GetTopIndex((System.Windows.Forms.ListView) this) : -1;
      }
      set
      {
    ...
    public virtual Color UnfocusedHighlightBackgroundColorOrDefault
    {
      get
      {
        return !this.UnfocusedHighlightBackgroundColor.IsEmpty ? this.UnfocusedHighlightBackgroundColor : SystemColors.Control;
      }
    }
    ...
    public virtual Color UnfocusedHighlightForegroundColorOrDefault
    {
      get
      {
        return !this.UnfocusedHighlightForegroundColor.IsEmpty ? this.UnfocusedHighlightForegroundColor : SystemColors.ControlText;
      }
    }
      ...
      set
      {
        ...
        else
        {
          ...
          this.CheckStateGetter = (CheckStateGetterDelegate) (modelObject =>
          {
            ...
            return nullable.HasValue ? (!nullable.Value ? CheckState.Unchecked : CheckState.Checked) : (!this.TriStateCheckBoxes ? CheckState.Unchecked : CheckState.Indeterminate);
          });
    ...
    protected virtual GroupingParameters CollectGroupingParameters(
      ...
      SortOrder secondaryOrder)
    {
      string countFormatOrDefault = this.ShowItemCountOnGroups ? groupByColumn.GroupWithItemCountFormatOrDefault : (string) null;
      string singularFormatOrDefault = this.ShowItemCountOnGroups ? groupByColumn.GroupWithItemCountSingularFormatOrDefault : (string) null;
      return new GroupingParameters(this, groupByColumn, groupByOrder, column, order, secondaryColumn, secondaryOrder, countFormatOrDefault, singularFormatOrDefault, this.SortGroupItemsByPrimaryColumn);
    }
    ...
    public virtual void CalculateReasonableTileSize()
    {
      ...
      this.TileSize = new Size(this.TileSize.Width == 0 ? 200 : this.TileSize.Width, Math.Max(this.TileSize.Height, Math.Max(val1, val2)));
    }
    ...
    {
      return objectsToConvert.Count == 0 ? string.Empty : new OLVExporter(this, (IEnumerable) objectsToConvert).ExportTo(OLVExporter.ExportFormat.HTML);
    }
    ...
    public virtual OLVListItem GetNextItem(OLVListItem itemToFind)
    {
      if (this.ShowGroups)
      {
        ...
        {
          foreach (OLVListItem nextItem in group.Items)
          {
            if (flag)
              return nextItem;
            flag = itemToFind == nextItem;
          }
        }
    ...
    public virtual OLVListItem GetPreviousItem(OLVListItem itemToFind)
    {
      if (this.ShowGroups)
      {
        OLVListItem previousItem = (OLVListItem) null;
        foreach (ListViewGroup group in this.Groups)
        {
          foreach (OLVListItem olvListItem in group.Items)
          {
            if (olvListItem == itemToFind)
              return previousItem;
            previousItem = olvListItem;
          }
        }
        return itemToFind != null ? (OLVListItem) null : previousItem;
      }
      if (this.GetItemCount() == 0)
        return (OLVListItem) null;
      if (itemToFind == null)
    ...
    internal void LowLevelScroll(int dx, int dy) => NativeMethods.Scroll((System.Windows.Forms.ListView) this, dx, dy);
    ...
    protected OlvListViewHitTestInfo LowLevelHitTest(int x, int y)
    {
      if (!this.ClientRectangle.Contains(x, y))
        return new OlvListViewHitTestInfo((OLVListItem) null, (OLVListSubItem) null, 0, (OLVGroup) null);
      ...
      return new OlvListViewHitTestInfo(olvListItem, subItem, hittest.flags, group);
    }
    ...
    protected virtual void CalculateStandardHitTest(OlvListViewHitTestInfo hti, int x, int y)
    {
      ...
      hti.HitTestLocation = HitTestLocation.InCell;
      if ((bounds with { Width = this.SmallImageSize.Width }).Contains(x, y))
      {
      ...
      rectangle.X += 4;
      if (flag)
        rectangle.X += this.SmallImageSize.Width;
      Size proposedSize = new Size(rectangle.Width, rectangle.Height);
      ...
      switch (hti.Column.TextAlign)
      {
        case HorizontalAlignment.Right:
          rectangle.X = bounds.Right - size.Width;
          break;
        case HorizontalAlignment.Center:
          rectangle.X += (bounds.Right - bounds.Left - size.Width) / 2;
          break;
      }
    ...
    public virtual void PauseAnimations(bool isPause)
    {
      ...
      {
        if (this.GetColumn(index).Renderer is ImageRenderer renderer)
    ...
    private void SubscribeNotifications(IEnumerable models)
    {
      ...
      {
        if (model is INotifyPropertyChanged key && !this.subscribedModels.ContainsKey((object) key))
        {
          key.PropertyChanged += new PropertyChangedEventHandler(this.HandleModelOnPropertyChanged);
          this.subscribedModels[(object) key] = (object) key;
        }
      }
    }
    ...
    private void UnsubscribeNotifications(IEnumerable models)
    {
      ...
      else
      {
        foreach (object model in models)
        {
          if (model is INotifyPropertyChanged key)
          {
            key.PropertyChanged -= new PropertyChangedEventHandler(this.HandleModelOnPropertyChanged);
            this.subscribedModels.Remove((object) key);
          }
        }
      }
    }
    ...
    {
      ObjectListView.ObjectListViewState graph = new ObjectListView.ObjectListViewState();
      graph.VersionNumber = 1;
      graph.NumberOfColumns = this.AllColumns.Count;
      graph.CurrentView = this.View;
      if (this.PrimarySortColumn != null)
        graph.SortColumn = this.AllColumns.IndexOf(this.PrimarySortColumn);
      graph.LastSortOrder = this.PrimarySortOrder;
      ...
      {
        graph.ColumnIsVisible.Add((object) allColumn.IsVisible);
        graph.ColumnDisplayIndicies.Add((object) allColumn.LastDisplayIndex);
        graph.ColumnWidths.Add((object) allColumn.Width);
      }
    ...
    {
      using (MemoryStream serializationStream = new MemoryStream(state))
      {
        BinaryFormatter binaryFormatter = new BinaryFormatter();
        ObjectListView.ObjectListViewState objectListViewState;
        try
        {
          objectListViewState = binaryFormatter.Deserialize((Stream) serializationStream) as ObjectListView.ObjectListViewState;
        }
    ...
    protected virtual bool HandleChar(ref Message m)
    {
      ...
      if (Environment.TickCount < this.timeLastCharEvent + 1000)
        this.lastSearchString += (string) (object) int32;
      else
        this.lastSearchString = int32.ToString((IFormatProvider) CultureInfo.InvariantCulture);
      ...
      if (matchingRow >= 0)
      {
        ...
        {
          this.SelectedIndices.Clear();
          ListViewItem itemInDisplayOrder = (ListViewItem) this.GetNthItemInDisplayOrder(matchingRow);
    ...
    protected virtual bool HandleCustomDraw(ref Message m)
    {
      ...
      switch (lparam.nmcd.dwDrawStage)
      {
        ...
        case 65538:
          ...
          break;
        case 196609:
          if (!this.OwnerDraw || lparam.iSubItem != 0 || this.Columns[0].DisplayIndex == 0)
            return false;
          ...
          using (Graphics graphics = Graphics.FromHdc(lparam.nmcd.hdc))
          {
            ...
            DrawListViewSubItemEventArgs e = new DrawListViewSubItemEventArgs(graphics, subItemBounds, (ListViewItem) olvListItem1, olvListItem1.SubItems[0], dwItemSpec, 0, this.Columns[0], (ListViewItemStates) lparam.nmcd.uItemState);
            this.OnDrawSubItem(e);
            Trace.Assert(!e.DrawDefault, "Default drawing is impossible in this situation");
          }
          m.Result = (IntPtr) 4;
          return true;
      }
    ...
    {
      if (state == 0U)
        return Enum.GetName(typeof (GroupState), (object) 0);
      List<string> stringList = new List<string>();
      foreach (int num in Enum.GetValues(typeof (GroupState)))
      {
        if (num != 0 && ((long) state & (long) num) == (long) num)
          stringList.Add(Enum.GetName(typeof (GroupState), (object) num));
      }
      return stringList.Count != 0 ? string.Join("|", stringList.ToArray()) : state.ToString("x");
    }
    ...
    {
      if (hti.Item == null || this.View != View.Details || hti.HitTestLocation != HitTestLocation.CheckBox)
        return false;
    ...
    {
      int num1 = m.LParam.ToInt32() & (int) ushort.MaxValue;
      int num2 = m.LParam.ToInt32() >> 16 & (int) ushort.MaxValue;
      this.lastMouseMoveChangedPosition = num1 != this.lastMouseMoveX || num2 != this.lastMouseMoveY;
      this.lastMouseMoveX = num1;
      this.lastMouseMoveY = num2;
      return false;
    }
    ...
    protected virtual bool HandleReflectNotify(ref Message m)
    {
      ...
      {
        case -188:
          flag = this.HandleGroupInfo(ref m);
          break;
        case -184:
          flag = this.HandleLinkClick(ref m);
          break;
        case -181:
          flag = this.HandleEndScroll(ref m);
          break;
        case -180:
          flag = this.HandleBeginScroll(ref m);
          break;
        case -158:
          flag = ((NativeMethods.NMLVGETINFOTIP) m.GetLParam(typeof (NativeMethods.NMLVGETINFOTIP))).iItem >= this.GetItemCount();
          break;
        case -156:
        ...
        case -101:
          ...
          if ((lparam2.uChanged & 8) != 0 && this.CalculateCheckState(lparam2.uOldState) != this.CalculateCheckState(lparam2.uNewState))
          {
        ...
        case -100:
          ...
          if ((lparam3.uChanged & 8) != 0 && this.CalculateCheckState(lparam3.uOldState) != this.CalculateCheckState(lparam3.uNewState))
          {
            lparam3.uChanged &= -9;
        ...
        case -16:
          ...
          break;
        case -12:
          flag = this.HandleCustomDraw(ref m);
          break;
        case -3:
          if (this.CheckBoxes)
          {
    ...
    {
      this.lastUpdateRectangle = NativeMethods.GetUpdateRect((Control) this);
    }
    ...
    protected virtual bool HandleWindowPosChanging(ref Message m)
    {
      ...
      if ((lparam.flags & 1) == 0 && lparam.cx < this.Bounds.Width)
        this.ResizeFreeSpaceFillingColumns(lparam.cx - (this.Bounds.Width - this.ClientSize.Width));
      return false;
    }
    ...
    public virtual ToolStripDropDown MakeColumnCommandMenu(ToolStripDropDown strip, int columnIndex)
    {
      ...
      if (strip.Items.Count > 0)
        strip.Items.Add((ToolStripItem) new ToolStripSeparator());
      string text1 = string.Format(this.MenuLabelSortAscending, (object) column.Text);
      if (column.Sortable && !string.IsNullOrEmpty(text1))
        strip.Items.Add(text1, (Image) ObjectListView.SortAscendingImage, (EventHandler) ((sender, args) => this.Sort(column, SortOrder.Ascending)));
      string text2 = string.Format(this.MenuLabelSortDescending, (object) column.Text);
      if (column.Sortable && !string.IsNullOrEmpty(text2))
        strip.Items.Add(text2, (Image) ObjectListView.SortDescendingImage, (EventHandler) ((sender, args) => this.Sort(column, SortOrder.Descending)));
      if (this.CanShowGroups)
      {
        string text3 = string.Format(this.MenuLabelGroupBy, (object) column.Text);
        if (column.Groupable && !string.IsNullOrEmpty(text3))
          strip.Items.Add(text3, (Image) null, (EventHandler) ((sender, args) =>
          {
      ...
      if (this.ShowGroups)
      {
        ...
        {
          string text4 = string.Format(this.MenuLabelUnlockGroupingOn, (object) column.Text);
          if (!string.IsNullOrEmpty(text4))
            strip.Items.Add(text4, (Image) null, (EventHandler) ((sender, args) =>
            {
        ...
        {
          string text5 = string.Format(this.MenuLabelLockGroupingOn, (object) column.Text);
          if (column.Groupable && !string.IsNullOrEmpty(text5))
            strip.Items.Add(text5, (Image) null, (EventHandler) ((sender, args) =>
            {
              this.ShowGroups = true;
        ...
        string text6 = string.Format(this.MenuLabelTurnOffGroups, (object) column.Text);
        if (!string.IsNullOrEmpty(text6))
          strip.Items.Add(text6, (Image) null, (EventHandler) ((sender, args) =>
          {
      ...
      {
        string text7 = string.Format(this.MenuLabelUnsort, (object) column.Text);
        if (column.Sortable && !string.IsNullOrEmpty(text7) && this.PrimarySortOrder != SortOrder.None)
          strip.Items.Add(text7, (Image) null, (EventHandler) ((sender, args) => this.Unsort()));
      }
      return strip;
    }
    ...
    public virtual bool IsChecked(object modelObject)
    {
      ...
      return olvListItem != null && olvListItem.CheckState == CheckState.Checked;
    }

    public virtual bool IsCheckedIndeterminate(object modelObject)
    {
      OLVListItem olvListItem = this.ModelToItem(modelObject);
      return olvListItem != null && olvListItem.CheckState == CheckState.Indeterminate;
    }
    ...
    protected virtual CheckState? GetCheckState(object modelObject)
    {
      ...
      return !this.PersistentCheckBoxes ? new CheckState?() : new CheckState?(this.GetPersistentCheckState(modelObject));
    }
    ...
    protected virtual CheckState PutCheckState(object modelObject, CheckState state)
    {
      ...
      return !this.PersistentCheckBoxes ? state : this.SetPersistentCheckState(modelObject, state);
    }
    ...
    public virtual void ToggleSubItemCheckBox(object rowObject, OLVColumn column)
    {
      ...
      CheckState toggledCheckState = this.CalculateToggledCheckState(column, checkState);
    ...
    private CheckState CalculateToggledCheckState(OLVColumn column, CheckState currentState)
    {
      ...
      {
        case CheckState.Checked:
          return !column.TriStateCheckBoxes ? CheckState.Unchecked : CheckState.Indeterminate;
        case CheckState.Indeterminate:
          return CheckState.Unchecked;
        default:
          return CheckState.Checked;
    ...
    {
      return index < 0 || index >= this.GetItemCount() ? (OLVListItem) null : (OLVListItem) this.Items[index];
    }

    public virtual object GetModelObject(int index) => this.GetItem(index)?.RowObject;
    ...
    {
      return this.GetItem(index)?.GetSubItem(columnIndex);
    }
    ...
    private void DoSort(OLVColumn columnToSort, SortOrder order)
    {
      ...
      if (sortingEventArgs.Canceled)
        return;
      IList selectedObjects = this.VirtualMode ? this.SelectedObjects : (IList) null;
      this.SuspendSelectionEvents();
      this.ClearHotItem();
    ...
    public virtual string GetHeaderToolTip(int columnIndex)
    {
      ...
      if (column == null)
        return (string) null;
      string headerToolTip = column.ToolTipText;
      if (this.HeaderToolTipGetter != null)
        headerToolTip = this.HeaderToolTipGetter(column);
    ...
    protected virtual void TriggerFormatRowEvent(int rowIndex, int displayIndex, OLVListItem olvi)
    {
      ...
      Color backColor = olvi.BackColor;
      for (int index = 0; index < this.Columns.Count; ++index)
        olvi.SubItems[index].BackColor = backColor;
    ...
    protected override void OnDrawSubItem(DrawListViewSubItemEventArgs e)
    {
      ...
      else
      {
        ...
        if (true)
        {
          bufferedGraphics = BufferedGraphicsManager.Current.Allocate(e.Graphics, bounds);
    ...
    {
      if (this.IsCellEditing || e.Button != MouseButtons.Left || (Control.ModifierKeys & (Keys.Shift | Keys.Control | Keys.Alt)) != Keys.None)
        return false;
      if (this.lastMouseDownClickCount == 1 && this.CellEditActivation == ObjectListView.CellEditActivateMode.SingleClick)
        return true;
      return this.lastMouseDownClickCount == 2 && this.CellEditActivation == ObjectListView.CellEditActivateMode.DoubleClick;
    }
    ...
    {
      if (item == null || subItemIndex < 0 && subItemIndex >= item.SubItems.Count || this.CellEditActivation == ObjectListView.CellEditActivateMode.None || !this.GetColumn(subItemIndex).IsEditable)
        return;
    ...
    public Rectangle CalculateCellEditorBounds(
      ...
      Size preferredSize)
    {
      Rectangle rectangle = this.View != View.Details ? this.GetItemRect(item.Index, ItemBoundsPortion.Label) : item.GetSubItemBounds(subItemIndex);
    ...
    protected virtual object GetControlValue(Control control)
    {
      switch (control)
      {
        ...
        case System.Windows.Forms.CheckBox _:
          return (object) ((System.Windows.Forms.CheckBox) control).Checked;
        default:
          try
          {
    ...
    internal object GetFirstNonNullValue(OLVColumn column)
    {
      ...
      {
        object firstNonNullValue = column.GetValue(this.GetModelObject(index));
      ...
      OLVListItem olvi)
    {
      ...
      if (!this.UseHotItem || olvi.Selected)
        return;
      this.ApplyRowStyle(olvi, (IItemStyle) this.HotItemStyle);
    }
    ...
    protected virtual void ApplyRowStyle(OLVListItem olvi, IItemStyle style)
    {
      ...
      else
      {
        olvi.UseItemStyleForSubItems = false;
        foreach (ListViewItem.ListViewSubItem subItem in olvi.SubItems)
          subItem.BackColor = !style.BackColor.IsEmpty ? style.BackColor : olvi.BackColor;
    ...
    protected virtual void DrawAllDecorations(Graphics g, List<OLVListItem> drawnItems)
    {
      ...
      foreach (OLVListItem drawnItem in drawnItems)
      {
        if (drawnItem.HasDecoration)
        {
          foreach (IDecoration decoration in (IEnumerable<IDecoration>) drawnItem.Decorations)
          {
            decoration.ListItem = drawnItem;
            decoration.SubItem = (OLVListSubItem) null;
            decoration.Draw(this, g, contentRectangle);
          }
        }
        foreach (OLVListSubItem subItem in drawnItem.SubItems)
        {
        ...
        if (this.SelectedRowDecoration != null && drawnItem.Selected)
        {
          this.SelectedRowDecoration.ListItem = drawnItem;
      ...
      if (this.UseHotItem && this.HotItemStyle != null && this.HotItemStyle.Decoration != null)
      {
        ...
        decoration.SubItem = decoration.ListItem != null ? decoration.ListItem.GetSubItem(this.HotColumnIndex) : (OLVListSubItem) null;
        decoration.Draw(this, g, contentRectangle);
      }
      if (!this.DesignMode)
        return;
    ...
    {
      this.FindGlassPanelForOverlay(overlay)?.Invalidate();
    }
    ...
    public virtual IModelFilter CreateColumnFilter()
    {
      ...
      return filters.Count != 0 ? (IModelFilter) new CompositeAllFilter(filters) : (IModelFilter) null;
    }
    ...
    {
      CheckState persistentCheckState = CheckState.Unchecked;
      if (model != null)
        this.CheckStateMap.TryGetValue(model, out persistentCheckState);
      return persistentCheckState;
    }
