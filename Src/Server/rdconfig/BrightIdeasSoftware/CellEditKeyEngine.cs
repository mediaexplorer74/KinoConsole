...
namespace BrightIdeasSoftware
{
  public class CellEditKeyEngine
  {
    ...
    protected virtual void HandleRowChange(Keys keyData, CellEditCharacterBehaviour behaviour)
    {
      ...
      {
        CellEditAtEdgeBehaviour editAtEdgeBehaviour = CellEditAtEdgeBehaviour.Wrap;
        this.CellEditKeyAtEdgeBehaviourMap.TryGetValue(keyData, out editAtEdgeBehaviour);
    ...
    {
      return !up ? this.ListView.GetNextItem(olvi) : this.ListView.GetPreviousItem(olvi);
    }
    ...
    protected List<OLVColumn> EditableColumnsInDisplayOrder
    {
      get
      {
        List<OLVColumn> columnsInDisplayOrder = new List<OLVColumn>();
        foreach (OLVColumn olvColumn in this.ListView.ColumnsInDisplayOrder)
        {
          if (olvColumn.IsEditable)
            columnsInDisplayOrder.Add(olvColumn);
        }
