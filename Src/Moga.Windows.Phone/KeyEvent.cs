...
namespace Moga.Windows.Phone
{
  ...
  public sealed class KeyEvent : IKeyEventPublicNonVirtuals
  {
    ...
    public extern KeyCode KeyCode { [MethodImpl(MethodCodeType = MethodCodeType.Runtime)] get; }

    public extern ControllerAction Action { [MethodImpl(MethodCodeType = MethodCodeType.Runtime)] get; }
  }
}
