...
namespace wp7coverflow
{
  public class CollectionFlowPanel : Panel
  {
    ...
    public CollectionFlowPanel()
    {
      ...
      this.AnimationFunction = (IEasingFunction) cubicEase;
    ...
    {
      foreach (FrameworkElement child in (PresentationFrameworkCollection<UIElement>) this.Children)
      {
    ...
    protected virtual Size ArrangeOverride(Size finalSize)
    {
      ...
      for (int index = 0; index < ((PresentationFrameworkCollection<UIElement>) this.Children).Count; ++index)
      {
        FrameworkElement child = (FrameworkElement) ((PresentationFrameworkCollection<UIElement>) this.Children)[index];
        child.Width = num1;
        child.Height = num2;
        ...
        if (this.Orientation == null)
          Storyboard.SetTargetProperty((Timeline) doubleAnimation2, new PropertyPath((object) TranslateTransform.YProperty));
        else
          Storyboard.SetTargetProperty((Timeline) doubleAnimation2, new PropertyPath((object) TranslateTransform.XProperty));
        ...
        ((Timeline) doubleAnimation3).Duration = Duration.op_Implicit(this.AnimationDuration);
        ...
        ((Timeline) doubleAnimation5).Duration = Duration.op_Implicit(this.AnimationDuration);
